...
func init() {
	gotenberg.MustRegisterModule(UnoconvFormat{})
}
...
func (UnoconvFormat) Descriptor() gotenberg.ModuleDescriptor {
	return gotenberg.ModuleDescriptor{
		ID:  "unoconvformat",
		New: func() gotenberg.Module { return new(UnoconvFormat) },
	}
}
...
func (mod UnoconvFormat) Metrics() ([]gotenberg.Metric, error) {
	return []gotenberg.Metric{
		{
			Name:        "unoconvformat_active_instances_count",
			Description: "Current number of active LibreOffice instances for format conversion.",
			Read: func() float64 {
...
// converts a document to giver format. It creates a dedicated LibreOffice instance
...
func (mod UnoconvFormat) Convert(ctx context.Context, logger *zap.Logger, inputPath, outputPath string, options Options) error {
	if options.Format == "" || !containsString(availableOutputFormats, options.Format) {
	...
	return fmt.Errorf("unoconvformat: %w", err)
}
...
// Interface guards.
var (
	_ gotenberg.Module          = (*UnoconvFormat)(nil)
	_ gotenberg.Provisioner     = (*UnoconvFormat)(nil)
	_ gotenberg.Validator       = (*UnoconvFormat)(nil)
	_ gotenberg.MetricsProvider = (*UnoconvFormat)(nil)
	_ API                       = (*UnoconvFormat)(nil)
	_ api.Router                = (*UnoconvFormat)(nil)
)
